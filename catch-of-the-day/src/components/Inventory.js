    ...
    return (
      <div className="inventory">
        ...
        {Object.keys(this.props.fishes).map((key) => (
          // for bi-directional data transfer, we pass the updateFish method down for editing existing fish
          // we also pass the key down as an index so we have access to it
          <EditFishForm
